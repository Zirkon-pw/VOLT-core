...
import { useWorkspaceViewStore } from '@kernel/workspace/panes/model/workspaceViewStore';
import {
  getTabLabelFromPath,
  hasPathPrefix,
  replacePathPrefix,
} from '@shared/lib/fileTree';
import { validateHostEditorConfig } from '@kernel/plugin-system/runtime/hostEditorCatalog';
