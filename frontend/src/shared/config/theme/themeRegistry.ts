...
const LIGHT_THEME_TOKENS: ThemeTokens = {
  ...
  '--color-bg-tertiary': '#e7dfd1',
  '--color-bg-hover': 'rgba(35, 157, 173, 0.08)',
  '--color-bg-active': 'rgba(35, 157, 173, 0.14)',
  '--color-surface-raised': '#f6f0e6',
  '--color-surface-elevated': 'rgba(246, 240, 230, 0.95)',
  '--color-surface-overlay': '#fbfaf6',
  '--color-surface-chrome': '#eee6da',
  '--color-surface-sunken': '#e2d9c9',
  '--surface-solid-primary': '#f6f0e6',
  '--surface-solid-secondary': '#eee6da',
  '--surface-solid-tertiary': '#e6ddce',
  '--surface-border-primary': 'rgba(95, 102, 109, 0.18)',
  '--surface-border-secondary': 'rgba(95, 102, 109, 0.12)',
  '--surface-translucent-primary': 'rgba(247, 244, 238, 0.86)',
  '--surface-translucent-secondary': 'rgba(244, 241, 234, 0.82)',
  '--color-selection-bg': 'rgba(35, 157, 173, 0.22)',
  '--color-selection-border': 'rgba(31, 135, 149, 0.48)',
  '--color-focus-ring': 'rgba(35, 157, 173, 0.28)',
  '--color-text-primary': '#1f2328',
  '--color-text-secondary': '#5f666d',
  '--color-text-tertiary': '#767f88',
  '--color-text-inverse': '#fdfcf8',
  '--color-accent': '#239dad',
  '--color-accent-hover': '#1f8795',
  '--color-accent-text': '#f7fbfc',
  '--color-border': '#d2cabd',
  '--color-border-strong': '#b8ae9d',
  '--color-divider': 'rgba(31, 35, 40, 0.11)',
  '--color-icon': '#7a838b',
