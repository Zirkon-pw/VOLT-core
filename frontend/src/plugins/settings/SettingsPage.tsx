...
import { PluginPermissionDialog } from '@kernel/plugin-system/ui/PluginPermissionDialog';
...
import { PluginCatalog } from './ui/PluginCatalog';
import { PluginSettingsView } from './ui/PluginSettingsView';
...
export function SettingsPage({
  ...
  const hasSelectedPluginSettings = Boolean(
    selectedPlugin?.manifest.settings?.customUI
    || (selectedPlugin?.manifest.settings?.sections ?? []).length > 0,
  );
